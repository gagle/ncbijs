...
const SAMPLE_CONCEPT_META = [
  ...
  '</Names>',
  '<Definitions>',
  '<Definition SAB="NCI">A rare genetic disorder.</Definition>',
  '<Definition SAB="MSH">An X-linked condition.</Definition>',
  '</Definitions>',
  '<AssociatedGenes>',
  '<Gene gene_id="4952" chromosome="X" cytogen_loc="Xq26.1">OCRL</Gene>',
  '</AssociatedGenes>',
  '<ModesOfInheritance>',
  '<ModeOfInheritance Name="X-linked recessive inheritance" CUI="C0241764"/>',
  '</ModesOfInheritance>',
  '<ClinicalFeatures>',
  '<ClinicalFeature Name="Intellectual disability" SDUI="HP:0001249" CUI="C3714756"/>',
  '<ClinicalFeature Name="Cataract" SDUI="HP:0000518" CUI="C0086543"/>',
  '</ClinicalFeatures>',
