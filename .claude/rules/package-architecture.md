...
Read `docs/package-architecture.md` for the full reference. This summarizes the key decisions.
...
When creating or modifying a package, follow `docs/adding-a-package.md`.
